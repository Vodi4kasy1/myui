...
local Color3.fromRGB(0, 0, 0)
local Color3.fromRGB(255, 165, 0)
local Color3.fromRGB(255, 140, 0)
local toolight = false
    for i,v in pairs(game.CoreGui:GetChildren()) do
if v.Name == "Foxys Library" then
        v:Destroy()
    end
end

if theme == "Normal" then
Color3.fromRGB(0, 0, 0) = Color3.fromRGB(32,32,32)
Color3.fromRGB(255, 165, 0) = Color3.fromRGB(26,26,26)
Color3.fromRGB(255, 140, 0) = Color3.fromRGB(176, 148, 255)
print("Theme selected: "..theme)
elseif theme == "Reverse" then
    Color3.fromRGB(0, 0, 0) = Color3.fromRGB(26,26,26)
    Color3.fromRGB(255, 165, 0) = Color3.fromRGB(32,32,32)
    Color3.fromRGB(255, 140, 0) = Color3.fromRGB(176, 148, 255)
    print("Theme selected: "..theme)
elseif theme == "Blood" then
    Color3.fromRGB(0, 0, 0) = Color3.fromRGB(32,32,32)
    Color3.fromRGB(255, 165, 0) = Color3.fromRGB(26,26,26)
    Color3.fromRGB(255, 140, 0) = Color3.fromRGB(138, 3, 3)
    print("Theme selected: "..theme)
elseif theme == "Gainsboro" then
    Color3.fromRGB(0, 0, 0) = Color3.fromRGB(32,32,32)
    Color3.fromRGB(255, 165, 0) = Color3.fromRGB(26,26,26)
    Color3.fromRGB(255, 140, 0) = Color3.fromRGB(220, 220, 221)
    toolight = true
    print("Theme selected: "..theme)
elseif theme == "Canary" then
    Color3.fromRGB(0, 0, 0) = Color3.fromRGB(32,32,32)
    Color3.fromRGB(255, 165, 0) = Color3.fromRGB(26,26,26)
    Color3.fromRGB(255, 140, 0) = Color3.fromRGB(255, 253, 130)
    print("Theme selected: "..theme)
elseif theme == "Emerald" then
    Color3.fromRGB(0, 0, 0) = Color3.fromRGB(32,32,32)
    Color3.fromRGB(255, 165, 0) = Color3.fromRGB(26,26,26)
    Color3.fromRGB(255, 140, 0) = Color3.fromRGB(68, 207, 108)
    print("Theme selected: "..theme)
elseif theme == "Crimson" then
    Color3.fromRGB(0, 0, 0) = Color3.fromRGB(32,32,32)
    Color3.fromRGB(255, 165, 0) = Color3.fromRGB(26,26,26)
    Color3.fromRGB(255, 140, 0) = Color3.fromRGB(214, 40, 57)
    print("Theme selected: "..theme)
elseif theme == "Deep Sea" then
    Color3.fromRGB(0, 0, 0) = Color3.fromRGB(32,32,32)
    Color3.fromRGB(255, 165, 0) = Color3.fromRGB(26,26,26)
    Color3.fromRGB(255, 140, 0) = Color3.fromRGB(40, 81, 214)
    print("Theme selected: "..theme)
end
...
Main.ImageColor3 = Color3.fromRGB(255, 165, 0)
...
Tabs.ImageColor3 = Color3.fromRGB(0, 0, 0)
...
Items.ImageColor3 = Color3.fromRGB(0, 0, 0)
...
Frame.ScrollBarImageColor3 = Color3.fromRGB(255, 165, 0)
...
TextButton1.TextColor3 = Color3.fromRGB(255, 140, 0)
end
Frame.Visible = true
...
TextButton_Roundify_2px_2.ImageColor3 = Color3.fromRGB(255, 165, 0)
...
TextButton.MouseButton1Click:Connect(function()
    ...
    if not IsDropped then
        IsDropped = true
        TextButton.TextColor3 = Color3.fromRGB(255, 140, 0)
...
DropdownContainer.ImageColor3 = Color3.fromRGB(255, 165, 0)
DropdownContainer.Visible = false
...
function InsideTab:CreateSlider(text, minvalue, maxvalue, callback)
    ...
    Frame_3.ImageColor3 = Color3.fromRGB(255, 165, 0)
    ...
    TextButton_Roundify_2px.ImageColor3 = Color3.fromRGB(255, 165, 0)
    ...
    SliderInner.ImageColor3 = Color3.fromRGB(255, 140, 0)
    ...
    TextLabel_2.TextColor3 = Color3.fromRGB(255, 140, 0)
...
Frame_t.ImageColor3 = Color3.fromRGB(255, 165, 0)
...
if enabled then
    Frame_t.ImageColor3 = Color3.fromRGB(255, 140, 0)
    if toolight then
    ...
    Frame_t.ImageColor3 = Color3.fromRGB(255, 165, 0)
    if toolight then
    Frame_2.ImageColor3 = Color3.fromRGB(255, 140, 0)
    end
    Frame_2.Position = UDim2.new(0, 3, 0.150000006, 0)
end
end
...
function InsideTab:CreateCheckbox(text,callback)
    ...
    MainCheatFrame.ImageColor3 = Color3.fromRGB(255, 165, 0)
    ...
    InsideCheatFrame.ImageColor3 = Color3.fromRGB(255, 165, 0)
    ...
    if enabledcheat then
        InsideCheatFrame.ImageColor3 = Color3.fromRGB(255, 140, 0)
    else
        InsideCheatFrame.ImageColor3 = Color3.fromRGB(255, 165, 0)
    end
    end
...
function InsideTab:CreateButton(text, callback)
    ...
    Button_Roundify_3px.ImageColor3 = Color3.fromRGB(255, 165, 0)
